...
export default function InternDashboard() {
  ...
  const fetchTickets = async () => {
    try {
      // Fetch tickets assigned to this intern or all tickets if no assignment field
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm sm:text-base text-gray-600">Track your assigned tickets and progress</p>
      </div>
