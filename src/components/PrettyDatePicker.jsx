...
export default function PrettyDatePicker({
  ...
  return (
    <div className={`relative w-full ${className}`}>
      <div
        className={`w-full inline-flex items-center justify-between gap-2 rounded-lg border border-gray-300 px-3 py-2 text-sm bg-white ${
      ...
      >
        <div className="min-w-0 flex items-center gap-2">
          ...
          <span className={`${hasValue ? 'text-gray-900' : 'text-gray-400'} truncate`}>
